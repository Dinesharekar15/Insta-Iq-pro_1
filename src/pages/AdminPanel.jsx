...
const AdminPanel = () => {
  ...
  // All asset references use /admin/assets/ path
  return (
          ...
          <div className="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
            <div className="widget-card widget-bg1">
              <div className="wc-item">
                ...
                <span className="wc-stats">$<span className="counter">18</span>M</span>
          ...
          <div className="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
            <div className="widget-card widget-bg2">
              <div className="wc-item">
                ...
                <div className="progress wc-progress">
                  <div className="progress-bar" role="progressbar" style={{ width: "88%" }} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <span className="wc-progress-bx">
                  <span className="wc-change">Change</span>
